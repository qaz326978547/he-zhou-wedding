...
<template>
  <section class="py-24 md:py-32 bg-wedding-cream text-center px-6">
    ...
    <div
      class="mt-10 max-w-sm mx-auto bg-white/70 backdrop-blur-md rounded-2xl shadow-soft border border-wedding-stone/50 p-8"
    >
      <!-- Header row -->
        ...
        >
          ...
          <template v-if="d === WEDDING_DAY">
            ...
            >
              ...
              >
                <path
                  d="M20,34 C20,34 5,24 5,14 C5,9 8.5,6 12.5,6 C15.5,6 17.5,7.5 20,11 C22.5,7.5 24.5,6 27.5,6 C31.5,6 35,9 35,14 C35,24 20,34 20,34Z"
                />
              </svg>
              <span
    ...
    <div class="mt-12 space-y-2 text-center">
      <p
        class="text-wedding-charcoal/70 font-display tracking-[0.15em] text-lg"
      >
        Nov 14, 2026｜Saturday
      </p>
      <p class="text-wedding-gold font-display tracking-[0.2em] text-lg">
        12:30 PM
      </p>
    </div>
  </section>
