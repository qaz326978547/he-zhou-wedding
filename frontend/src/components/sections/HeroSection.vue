...
onMounted(() => {
  requestAnimationFrame(() => {
    setTimeout(() => { active.value = true }, 60)
  })
})
...
<template>
  <section class="hero-section relative min-h-screen overflow-hidden bg-wedding-cream">
    ...
    <div
      ...
      style="height: 42%; background: linear-gradient(to top, #FAF8F5 0%, rgba(250,248,245,0.85) 35%, rgba(250,248,245,0.2) 70%, transparent 100%);"
    />
    ...
    <div
      ...
      style="height: 33%; background: linear-gradient(to top, rgba(250,248,245,0.93) 0%, rgba(250,248,245,0.55) 45%, rgba(250,248,245,0.05) 85%, transparent 100%);"
    />
    ...
    >
      ...
      <p
        ...
        style="--delay: 0.25s; --write-dur: 2.0s"
      >
        We got Married
      </p>
    </div>
    ...
    >
      ...
      >
        ...
        <div class="text-center">
          <p class="font-sans font-light text-2xl md:text-3xl text-wedding-charcoal tracking-[0.12em] leading-tight">
            何啟賢
          </p>
        ...
        <!-- Separator -->
        <span class="font-display text-wedding-gold/55 text-xl md:text-2xl leading-none select-none">/</span>
...
.hero-active .hero-write {
  animation: heroWriteIn var(--write-dur, 1.8s) cubic-bezier(0.23, 1, 0.32, 1) both;
  animation-delay: var(--delay, 0s);
}
