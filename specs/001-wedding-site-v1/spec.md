...
**中文字體策略 SHOULD**：
- 中文姓名 SHOULD 使用高級感 CJK 字型：Noto Serif TC、思源宋體、蘋方（PingFang）或同等字型
- 中文主姓名 SHOULD NOT 使用手寫字體，以維持可讀性
- 中文手寫字體（清松手寫體、芫荽、霞鶩文楷等）保留用於輔助文案、quote、短句，不作為主姓名字型
- 無額外 CJK 字型載入時，系統 sans-serif 字型堆疊（PingFang / Hiragino / Microsoft JhengHei）已可呈現精緻效果
...
- **字型**：英文大標題 / 手寫情感字使用 Great Vibes 或 Pinyon Script（手寫書法體）；英文正文標題使用 Cormorant Garamond 或 Playfair Display（精緻 serif）；中文使用系統字型堆疊（PingFang / Hiragino / Microsoft JhengHei / Noto Serif TC 等 CJK 字型）；中文主姓名 SHOULD NOT 使用手寫字體，以維持可讀性
