...
- Q: 婚禮儀式 / 宴客開始時間為何（倒數計時目標時刻）？ → A: 2026-11-14 12:15（台灣時間 UTC+8）；倒數計時以此時刻為目標。
...
2. **Given** 賓客滾動至倒數計時區塊，**When** 頁面渲染，**Then** 倒數計時顯示距 2026-11-14 12:15（UTC+8）的剩餘天數、小時、分鐘、秒數，並即時更新。
...
#### FR-003 婚禮倒數計時
系統 MUST 顯示即時倒數計時器，計算距 2026-11-14 12:15（台灣時間 UTC+8，宴客開始時間）剩餘的天、時、分、秒，
...
#### FR-006 婚禮資訊區塊
系統 MUST 顯示婚宴詳細資訊，包含：
- 婚禮日期與時間（2026-11-14 12:15 UTC+8）
- 宴客地點名稱：**全國大飯店 2F**
